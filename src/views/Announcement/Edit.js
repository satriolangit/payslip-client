...
const Edit = ({ match, history }) => {
  ...
  const update = async () => {
    ...
    try {
      const url = ApiUrl + "/announcement/update";
      await axios.post(url, formData, JsonContentType);
      history.push("/admin/announcement");
    } catch (err) {
      console.log(err);
  ...
  const loadData = async () => {
    if (match.params.id !== "0") {
      try {
        const url = ApiUrl + "/announcement/item/" + match.params.id;
                ...
                <FormGroup row>
                  ...
                  <Col xs="12" md="9">
                    <Input
                      ...
                      onChange={onChange}
                    />
                    <FormText color="muted">Title pengumuman</FormText>
                  </Col>
                </FormGroup>
                <FormGroup row>
                  <Col md="3">
                  ...
                  <Col xs="12" md="9">
                    <Editor
                      ...
                      toolbar={toolbar}
                    />
                    <FormText color="muted">Text pengumuman</FormText>
                  </Col>
                </FormGroup>
              </CardBody>
              <CardFooter>
