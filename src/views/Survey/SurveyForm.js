...
const SurveyForm = () => {
  ...
  const { reason, result, department, departmentName } = data;
  ...
  const fetchDepartment = async () => {
    try {
      const url = `${ApiUrl}/master/department/${user.departmentId}`;
              ...
              <Card>
                <CardHeader>
                  ...
                  <div className="row">
                    <div className="col-md-12 center-text">
                      <h6>
                        Lapor catering adalah media control terbaru untuk
                        kualitas catering yang lebih baik<br></br>
                        Silahkan sampaikan apa saja yang menjadi keluhan
                        ketidakpuasan anda atau kepuasan anda.
                      </h6>
                    </div>
                  </div>
                </CardHeader>
