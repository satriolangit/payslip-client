...
const Ideasheet = ({ data, width }) => {
    ...
    <View style={styles.header}>
      ...
      <View style={{ flexGrow: 1 }}>
        <View style={{ borderWidth: 1, padding: 1, flexGrow: 1 }}>
          <Text style={{ fontSize: 10 }}>Tgl. Efektif : 3 Januari 2022</Text>
        </View>
  ...
  const kopHeader = (
    <View style={kop.container}>
      ...
      <View style={kop.section}>
        <Text style={{ fontSize: 16, display: "flex", alignSelf: "center" }}>
          IDEA SHEET
        </Text>
      </View>
      <View style={kop.section}>
  ...
  const content = (master, detail, impact) => (
    <View style={{ borderWidth: 1 }}>
      ...
      <View style={sheet.row}>
        <View style={sheet.cell}>
          <Text style={sheet.font8}>
            Isi nama, departemen, tanggal, tema, NIK, dan area dengan jelas
            tanpa di singkat.
          </Text>
        </View>
      </View>
      ...
      >
        ...
        >
          <Image
            source={
              master.isIdeasheet === 1 ? checkboxChecked : checkboxUnchecked
            }
        ...
        >
          <Image
            source={
              master.isIdeasheet === 0 ? checkboxChecked : checkboxUnchecked
            }
            style={sheet.checkbox}
          />
          <Text
      ...
      <View style={{ display: "flex", flexDirection: "row" }}>
        ...
        >
          <Text style={{ fontSize: 12 }}>Nilai Kaizen jika di Rupiahkan</Text>
        </View>
        <View
          style={{
            borderWidth: 1,
